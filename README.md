Sentry-with-DockerYou can find the pem file I received at first on the server you opened on amazon. Here we first set up putty, which will provide us with communication with 
